...
if __name__ == "__main__":
    ...
    data = pd.read_csv(os.path.join('./resultsLR2HR/lightning_logs/',version_name,'metrics.csv'),header=0)
    ...
    plt.savefig(os.path.join('./resultsLR2HR/lightning_logs/',version_name,'loss.png'),dpi=300)
